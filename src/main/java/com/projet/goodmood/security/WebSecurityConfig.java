package com.projet.goodmood.security;
...
import com.projet.goodmood.security.jwt.AuthEntryPointJwt;
import com.projet.goodmood.security.jwt.AuthTokenFilter;
import com.projet.goodmood.service.UsersDetailsServiceImpl;
  ...
  */
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/roleuser/**").permitAll()
                .antMatchers("/domaine/**").permitAll()
                .antMatchers("/citation/**").permitAll()
